...
//*****************     Assignment-33
//create a variable to hold .main-controls
var $playPause = $('.main-controls .play-pause');

//create function togglePlayFromPlayerBar with no arguments
var togglePlayFromPlayerBar = function () {
  //if song is paused and play button clicked change song number cell from play button to pause button
  if (currentSoundFile.isPaused()) {
    var currentlyPlayingCell = getSongNumberCell(currentlyPlayingSongNumber);
  ...
  //if song is playing and pause button is clicked
    ...
    var currentlyPlayingCell = getSongNumberCell(currentlyPlayingSongNumber);
    //change the HTML of the player bars pause button to play button
...
$(document).ready(function() {
  ...
  //add click event to in doc ready and use togglePlay as event handler
